...
| Artifact | Role |
|---|---|
| [`D-03-ACCEPTANCE.md`](D-03-ACCEPTANCE.md) | Binding scope of the causal event–fluent research direction |
| [`D-01P-ACCEPTANCE.md`](D-01P-ACCEPTANCE.md) | Binding owner acceptance of the portfolio About-page scope |
...
| [`AMNESIA-ORACLE-EXPERIMENT.md`](AMNESIA-ORACLE-EXPERIMENT.md) | Pinned static product/docs evidence, history observations, execution limits, and technical sub-gate |
| [`EVENT-FLUENT-EXPERIMENT.md`](EVENT-FLUENT-EXPERIMENT.md) | Technical fixture method, trace, E-01–E-10 results, comparison, and falsification conditions |
| [`PORTFOLIO-PROSE-CANDIDATE-AUDIT.md`](PORTFOLIO-PROSE-CANDIDATE-AUDIT.md) | Pre-decision portfolio scope/evidence audit |
| [`PORTFOLIO-PROSE-EXPERIMENT.md`](PORTFOLIO-PROSE-EXPERIMENT.md) | Executed prose fixture, P-01–P-12 results, and limitations |
| [`PAIRED-DOMAIN-RESULT.md`](PAIRED-DOMAIN-RESULT.md) | C-01–C-07 cross-domain result and required refinements |
...
| [`fixtures/amnesia-notes-event-fluent.json`](fixtures/amnesia-notes-event-fluent.json) | Technical research-only trace; not a corpus |
| [`fixtures/portfolio-about-event-fluent.json`](fixtures/portfolio-about-event-fluent.json) | General-prose research-only trace; not a corpus |
| [`fixtures/paired-domain-proof.json`](fixtures/paired-domain-proof.json) | Immutable cross-result binding and co-gate claims |
| [`tools/validate_event_fluent_fixture.py`](tools/validate_event_fluent_fixture.py) | Technical standard-library fixture validator |
| [`tools/validate_portfolio_prose_fixture.py`](tools/validate_portfolio_prose_fixture.py) | General-prose standard-library fixture validator |
| [`tools/validate_paired_domain.py`](tools/validate_paired_domain.py) | Cross-result binding and non-overstatement validator |
| [`results/amnesia-notes-event-fluent-validation.json`](results/amnesia-notes-event-fluent-validation.json) | Committed deterministic technical result |
| [`results/portfolio-about-event-fluent-validation.json`](results/portfolio-about-event-fluent-validation.json) | Committed deterministic prose result |
| [`results/paired-domain-validation.json`](results/paired-domain-validation.json) | Committed paired-domain result |
