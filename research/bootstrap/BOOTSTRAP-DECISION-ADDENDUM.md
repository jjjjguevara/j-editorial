...
The Amnesia half is further scoped in [`AMNESIA-DOCS-SLICE-AUDIT.md`](AMNESIA-DOCS-SLICE-AUDIT.md). The identity of the prose artifact remains a pivotal owner decision because it determines its purpose, rights, audience, evidence sources, and acceptable editorial outcomes.
...
The complete reasoning, counterexamples, and revised decision are in [`D-02-SEMANTIC-CENTER-REVIEW.md`](D-02-SEMANTIC-CENTER-REVIEW.md).
