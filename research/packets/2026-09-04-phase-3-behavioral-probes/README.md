...
in `research/packets/2026-09-04-phase-1-adversarial-review/NEXT-PHASE-CONTRACT.md`.
...
```bash
python3 research/packets/2026-09-04-phase-3-behavioral-probes/tools/run_experiments.py --output /tmp/je-phase3.json
```
