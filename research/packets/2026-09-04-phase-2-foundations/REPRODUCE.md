...
```bash
python3 research/programs/prose/tools/validate_portfolio_prose_fixture.py \
  research/programs/prose/fixtures/portfolio-about-event-fluent.json \
  --output research/programs/prose/results/portfolio-about-event-fluent-validation.json
```
...
```bash
python3 research/programs/paired-synthesis/tools/validate_paired_domain.py \
  research/programs/paired-synthesis/fixtures/paired-domain-proof.json \
  research/programs/event-state/results/amnesia-notes-event-fluent-validation.json \
  research/programs/prose/results/portfolio-about-event-fluent-validation.json \
  --output research/programs/paired-synthesis/results/paired-domain-validation.json
```
...
Under `research/decisions/AMNESIA-ORACLE-AUTHORIZATION.md`, an authorized isolated environment may verify:
