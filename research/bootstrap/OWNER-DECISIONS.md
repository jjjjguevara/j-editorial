...
The current favored research hypothesis is a **causal event–fluent editorial state machine**, not pure event sourcing. It is documented in [`D-03-EVENT-STATE-REVIEW.md`](D-03-EVENT-STATE-REVIEW.md).
