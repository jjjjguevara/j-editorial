...
| `research/model-training-data/CHARTER.md` | Terminology and dependency alignment only; retain held status and prohibit execution. |
| `research/bootstrap/*` | Move from revised decision hold to active phase-2 research and preserve owner answers verbatim. |
